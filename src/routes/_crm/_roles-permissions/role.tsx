...
function RouteComponent() {
  ...
  const openModal = (type: "add" | "edit" | "delete" | "detail", item?: RoleDto) => {
      ...
      <div className="content pb-0">
        ...
        <div className="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
          <div>
            ...
            <div className="text-muted small">Chức vụ / Danh sách</div>
          </div>
            ...
            >
              {() => (
                <DataTable
                  ...
                  toolbarRight={<AddButton label="Thêm chức vụ" onClick={() => openModal("add")} />}
